          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-16">
            ...
            <Link href="/problem" className="group block">
              <div className="bg-gray-900/50 backdrop-blur-xl border border-gray-800 rounded-2xl p-8 transition-all duration-300 hover:-translate-y-2 card-glow">
                <div className="flex items-center justify-center w-16 h-16 bg-emerald-500/10 rounded-xl mb-6 mx-auto">
                ...
                <div className="bg-gradient-to-r from-emerald-600 to-emerald-600 text-white px-6 py-3 rounded-xl text-center font-semibold transition-all duration-300 group-hover:from-emerald-500 group-hover:to-emerald-500 button-glow">
                  Explore the Problem →
                </div>
              </div>
            </Link>
            ...
            <Link href="/strategy" className="group block">
              <div className="bg-gray-900/50 backdrop-blur-xl border border-gray-800 rounded-2xl p-8 transition-all duration-300 hover:-translate-y-2 card-glow">
                <div className="flex items-center justify-center w-16 h-16 bg-sky-500/10 rounded-xl mb-6 mx-auto">
                  <Image src="/abicon.svg" alt="AirBooks Logo" width={48} height={48} className="w-12 h-12" />
                </div>
                <h2 className="text-2xl font-bold text-center mb-4 text-sky-400">
                  AirBooks Strategy
                </h2>
                <p className="text-gray-400 leading-relaxed text-center mb-8">
                  Our comprehensive strategy for rebuilding capital markets infrastructure while building best-in-class applications.
                </p>
                <div className="bg-gradient-to-r from-sky-600 to-sky-600 text-white px-6 py-3 rounded-xl text-center font-semibold transition-all duration-300 group-hover:from-sky-500 group-hover:to-sky-500 button-glow">
                  View Strategy →
                </div>
              </div>
            </Link>
